...
export const MetaVideo = styled.video`
  visibility: visible;
  ...
  left: 0px;
  width: 920px;
  --border-glow: 0 0 6px 2px #d0a435, 0 0 18px 3px #d0a435, 0 0 36px 4px #ec1f24,
    0 0 36px 4px #ec1f24, 0 0 30px 10px rgba(19, 111, 231, 0.8);
  box-shadow: var(--border-glow);
  border: 3px solid #d0a435;
